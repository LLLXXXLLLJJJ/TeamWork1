...
public class face {
    ...
    private static final String APPID = "5d2437e9";
    // 接口密钥(webapi类型应用开通人脸比对服务后，控制台--我的应用---人脸比对---相应服务的apikey)
    private static final String API_KEY = "bf8e8008042516add4c5727c665ebdbf";
    // 图片地址
    private static final String FILE_PATH1 = "F:\\workspace_2022\\iflytek_aiui\\src\\main\\resources\\static\\img\\3.jpeg";
    private static final String FILE_PATH2 = "F:\\workspace_2022\\iflytek_aiui\\src\\main\\resources\\static\\img\\5.jpeg";
    /**
     * OCR WebAPI 调用示例程序
     *
     * @param args
    ...
    public static void main(String[] args) throws IOException, JSONException {
        ...
        // {id:xx,data:xxx,msg:xxx,resid:xx}
        FaceResp faceResp = JSON.parseObject(result, FaceResp.class);
        System.out.println(faceResp);
        //	错误码链接：https://www.xfyun.cn/document/error-code （code返回错误码时必看）
    }
    ...
    public static float compare(String file1, String file2)  {
        try {
            Map<String, String> header = buildHttpHeader();
            //图片1和图片二Base64编码之后需要urlencode
            byte[] imageByteArray1 = FileUtil.read(file1);
            String imageBase641 = new String(Base64.encodeBase64(imageByteArray1), "UTF-8");
            byte[] imageByteArray2 = FileUtil.read(file2);
            String imageBase642 = new String(Base64.encodeBase64(imageByteArray2), "UTF-8");
            String result = HttpUtil.doPost1(WEBWFV_URL, header, "first_image=" + URLEncoder.encode(imageBase641, "UTF-8") + "&" + "second_image="+ URLEncoder.encode(imageBase642, "UTF-8"));
            System.out.println("人脸比对接口调用结果：" + result);
            // {id:xx,data:xxx,msg:xxx,resid:xx}
            FaceResp faceResp = JSON.parseObject(result, FaceResp.class);
            return faceResp.getData();
        } catch (IOException e) {
            return 0f;
        }
